...
namespace IngameDebugConsole
{
    ...
    public class DebugLogManager : MonoBehaviour
    {
        ...
        [SerializeField] private float minimumHeight = 200f;

        // Should command input field be cleared after pressing Enter
        [SerializeField] private bool startInPopupMode = true;

        [SerializeField] private bool clearCommandAfterExecution = true;

        [SerializeField] private bool receiveLogcatLogsInAndroid;

        [SerializeField] private string logcatArguments;
        ...
        private void OnEnable()
        {
            ...
            if (instance == null)
            {
                ...
                recycledListView.Initialize(this, collapsedLogEntries, indicesOfListEntriesToShow,
        ...
        public void Resize(BaseEventData dat)
        {
            ...
            var newHeight = (eventData.position.y - logWindowTR.position.y) / -canvasTR.localScale.y + 36f;
